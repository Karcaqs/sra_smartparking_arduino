...
// set mac
#include "esp_wifi.h"  
uint8_t newMACAddress[6] = {0x24, 0xDC, 0xC3, 0x48, 0x5D, 0x6C};  // Must be unicast + locally administered

esp_now_peer_info_t peerInfo;

// Pin untuk komunikasi I2C (IRQ dan RESET)
// #define PN532_IRQ   (17)    // Bisa diganti sesuai kebutuhan
// #define PN532_RESET (16)    // Bisa diganti sesuai kebutuhan
#define PN532_SDA   (21)
#define PN532_SLC   (22)
